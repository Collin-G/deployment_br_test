...
class AudioHandler():
    ...
    def extract_mfcc_with_sliding_window(self, 
    ...
    def get_mfcc_features(self):
        mfcc_batches = self.extract_mfcc_with_sliding_window(self.file)
        # You can perform any other operation here like saving the MFCCs, further processing, etc.
        normalized_mfcc_batches = self.normalize_mfcc_batches(mfcc_batches)
